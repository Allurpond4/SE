		...
		<tr align="char">
			<td>
				...
				<table border="1" width="600px"><br>
					...
					<?php 										//---------------------คิดยอดรวมราคา---------------------
									if($Total5 != "" ) {$Total = (intval($Total1))+(intval($Total2))+(intval($Total3))+(intval($Total4))+(intval($Total5));	}
									else if($Total4 != "") {$Total = (intval($Total1))+(intval($Total2))+(intval($Total3))+(intval($Total4));	}
									else if($Total3 != "") {$Total = $Total1+$Total2+$Total3;	}
									else if($Total2 != "") {$Total = $Total1+$Total2;	}
									else {$Total = $Total1;}?>
